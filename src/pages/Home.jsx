            ...
            <section className={"feeds"}>
                ...
                <div className="makeTweet flex">
                    ...
                    <div className="tweet-box w-full px-5">
                        <div
                            className={"border px-2 w-max rounded-2xl border-gray-500 text-[#1d9bf0] flex"}
                            style={{fill: "#1d9bf0"}}> Everyone <svg viewBox={"0,0,24,24"} className={"w-5"}
                                                                     style={{fill: "#1d9bf0"}}>
                            <g>
                                <path
                        ...
                        <div>
                            ...
                            <div
                                className={"mb-2 cursor-pointer others text-[#1d9bf0] flex gap-1 p-[.10rem] px-2 hover:bg-blue-900 w-max rounded-2xl"}>
                                <svg viewBox="0,0,24,24" className={"w-5"} style={{fill: "#1d9bf0"}}>
                                    <path
                            ...
                            <div className={'flex justify-between mt-2'}>
                                <div className={"inner-list flex gap-3"}>
                                ...
                                <div className={'tweet-button p-2 px-3 rounded-2xl  bg-blue-400'}>Tweet</div>
                            </div>
                        </div>
                ...
                <main className={"post-feeds"}>
                    ...
                    <div className={"post "}>
                        ...
                        <div className={"post-con"}>
                            ...
                            <div>
                                one day we will talk about how single-sex schools are doing more harm than good
                            </div>
                        </div>
