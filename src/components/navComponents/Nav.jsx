...
function Nav(props) {
    ...
    return (
        <nav className={"side-nav text-black"}>
            <div className={"nav-con"}>
                ...
                <NavItems to={'home'} g1={<>
                    ...
                    <path
                        d="M8.22 12.184c0 2.084 1.695 3.78 3.78 3.78s3.78-1.696 3.78-3.78-1.695-3.78-3.78-3.78-3.78 1.696-3.78 3.78zm6.06 0c0 1.258-1.022 2.28-2.28 2.28s-2.28-1.022-2.28-2.28 1.022-2.28 2.28-2.28 2.28 1.022 2.28 2.28z"></path>
                ...
                <NavItems to={"messages"}
                    ...
                    <path
                        d="M11.55 12.082c.273.182.627.182.9 0L22 5.716V5.5c0-1.24-1.01-2.25-2.25-2.25H4.25C3.01 3.25 2 4.26 2 5.5v.197l9.55<g> 6.385z"></path>
                    <path
                        d="M13.26 13.295c-.383.255-.82.382-1.26.382s-.877-.127-1.26-.383L2 7.452v11.67c0 1.24 1.01 2.25 2.25 2.25h15.5c1.24 0 2.25-1.01 2.25-2.25V7.47l-8.74 5.823z"></path>
                </>}
                          name={"Messages"}/>
                <NavItems to={"bookmarks"}
                          g1={<g>
                              <path
                          ...
                          g2={<g>
                              <path
                                  d="M19.9 23.5c-.2 0-.3 0-.4-.1L12 17.9l-7.5 5.4c-.2.2-.5.2-.8.1-.2-.1-.4-.4-.4-.7V5.6c0-1.2 1-2.2 2.2-2.2h12.8c1.2 0 2.2 1 2.2 2.2v17.1c0 .3-.2.5-.4.7 0 .1-.1.1-.2.1z"></path>
                          </g>}
                          name={"Bookmarks"}/>
                <NavItems to={"list"}
                          g1={<g>
                ...
                <button className={"nav-items"}>
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="w-10">
                        <g>
                ...
                <button className={"nav-items tweet-button"}>
                    <svg viewBox="0 0 24 24" aria-hidden="true" className={"w-10"}>
                        <g>
                            <path
            ...
            <button className={"user-button nav-items mb-5 items-center"}>
                ...
                <div className={'flex flex-col'}>
                    ...
                    <p className={"text-gray-500"}>@jojothomas1515</p>
                </div>
